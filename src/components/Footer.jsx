        ...
        <div className="py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Create and discover local events.</p>
            </div>
          </div>

          <div className="flex items-center gap-6">
            <a href="/createevents" className="text-sm text-gray-600 hover:text-indigo-600 transition-colors">
              Create
            </a>

            <a
              href="https://github.com/Pmaan01/EventHub"
              target="_blank"
